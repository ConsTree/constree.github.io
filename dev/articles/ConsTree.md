...
[`Strict()`](https://constree.github.io/dev/reference/Strict.md) keeps
only the two groupings that occur in every tree;
[`Majority()`](https://constree.github.io/dev/reference/Majority.md)
adds those that occur in more than half;
[`Frequency()`](https://constree.github.io/dev/reference/Frequency.md)
keeps any grouping that beats every grouping it conflicts with; and
[`Greedy()`](https://constree.github.io/dev/reference/Greedy.md) adds
...
[`Loose()`](https://constree.github.io/dev/reference/Loose.md) (the
...
[`RStar()`](https://constree.github.io/dev/reference/RStar.md) and
[`Local()`](https://constree.github.io/dev/reference/Local.md) treat the
...
An [`Adams()`](https://constree.github.io/dev/reference/Adams.md)
consensus may display groupings that no input tree contains.
[`RStar()`](https://constree.github.io/dev/reference/RStar.md) keeps
each rooted triplet that wins a plurality over both alternatives;
[`Local()`](https://constree.github.io/dev/reference/Local.md) returns
...
[`Quartet()`](https://constree.github.io/dev/reference/Quartet.md) is
the quartet-distance analogue, seeking (an approximation to) the tree
that minimizes the total quartet distance to the inputs instead
(Takazawa et al., 2026). Because the quartet distance gives extra weight
to deep branches, the result is often more resolved than the
majority-rule tree:
